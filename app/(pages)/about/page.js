    ...
    <div className="flex flex-col min-h-screen mx-auto mt-10 sm:mt-32 lg:mt-40 w-10/12">
      ...
      <div className="mt-10 grid grid-cols-1 md:grid-cols-2">
        <div className="col-span-1">
          <p className="mb-3">I am a final year Criminology PhD student at Swansea University.</p>
          <p className="my-3">I study gender in the online extreme right, and I do this by scraping and crawling extremist websites and discursively analysing the textual content I find there.</p>
